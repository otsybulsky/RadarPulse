...
У програмних системах роль чорного ящика часто помилково віддають логам. Розробник додає `Console.WriteLine`, потім verbose mode, а після першої аварії production отримує або тишу, або лавину тексту, в якій неможливо знайти першу причину. Лог стає шумом, якщо за ним немає моделі.
