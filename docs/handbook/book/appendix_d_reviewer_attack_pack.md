...
## Як виглядає сильна відповідь на співбесіді
...
Саме такий режим розмови ця книга має провокувати.
