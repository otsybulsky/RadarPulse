# Додаток Г: набір атак рецензента
...
Повна змодельована сесія з уточнювальними питаннями, вердиктом і нотатками про продукційні докази винесена в [Додаток Д](appendix_e_simulated_hostile_reviewer_transcript.md). Цей набір атак лишається короткою картою питань; Додаток Д показує, як має звучати захист.
...
| 4-9 хв | [Додаток Б](appendix_b_claim_evidence_matrix.md) | Чи кожне сильне твердження має код, тест, вимірювання й межу; чи незаявлені твердження названі явно |
