...
| “Як ви довели, що криза спільного стану була реальною?” | Чи проблему не вигадано після факту | [Розділ 16](chapter_16_mutable_core.md) | [Milestone 021: криза спільного стану](../../milestones/021-ordered-concurrent-runtime-archive-processing-slice-3-blocker.md), [RadarProcessingBatchDelta.cs](../../../src/Domain/Processing/Core/Models/RadarProcessingBatchDelta.cs) | Старий design змішував compute і mutation; delta/ordered commit розірвав цей шлях |
