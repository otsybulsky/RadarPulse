...
Криза спільного стану сформулювала жорсткий діагноз: *«Мутаційна семантика RadarProcessingCore не може безпечно підтримувати перекриття батчів без ізоляції стану, злиття або шару впорядкованого комміту»*. Просте буферизоване впорядкування на виході, яке ми створили в попередньому розділі, захищало лише спостерігача, але воно не могло повернути час назад і скасувати руйнівні мутації, що вже відбулися в пам'яті.
...
Коли Старшина черги вирішує, що настав час зафіксувати результати певного батча, його дельта потрапляє у вузьке горлечко послідовного запису. Метод [`CommitProcessingDelta`](../../../src/Domain/Processing/Core/Services/RadarProcessingCore/RadarProcessingCore.Deltas.cs) виконується строго в один потік, по черзі:

1. Координатор бере [`RadarProcessingBatchDelta`](../../../src/Domain/Processing/Core/Models/RadarProcessingBatchDelta.cs) для поточного sequence.
...
1. Паралельний розрахунок воркерами немутабельних дельт ([`RadarProcessingBatchDelta`](../../../src/Domain/Processing/Core/Models/RadarProcessingBatchDelta.cs)).
...
* **Немутабельність обчислень**: Ядро [`RadarProcessingCore`](../../../src/Domain/Processing/Core/Services/RadarProcessingCore/RadarProcessingCore.cs) не може бути змінене з паралельних потоків.
...
| :--- | :--- | :--- |
| Криза спільного стану справді блокувала безпечні active batches | Milestone 021 прямо фіксує, що active batch capacity > 1 небезпечний без snapshot/merge/ordered commit layer | [Milestone 021: криза спільного стану](../../milestones/021-ordered-concurrent-runtime-archive-processing-slice-3-blocker.md) |
| Дельти й ordered commit прибрали кризу без значного full-cache tax | Milestone 021 matrix: `active=4 elapsed ratio 0.994x`, `steady allocation ratio 1.006x`, checksum matched, release failures `0` | [project-progress.md](../../project-progress.md) |
...
* Тести кризи спільного стану: [Milestone 021: криза спільного стану](../../milestones/021-ordered-concurrent-runtime-archive-processing-slice-3-blocker.md)
