...
До цієї кризи клас `RadarProcessingCore` був класичним монолітом із накопичувальним станом. Усередині нього містився об'єкт `RadarSourceProcessingStateStore`, який зберігав масиви даних про кожне радарне джерело (кількість оброблених подій, суми значень, мітки часу тощо).
