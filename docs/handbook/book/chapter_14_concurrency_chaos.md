...
Уявімо фізичну картину обробки метеорологічних радарів NEXRAD Level II. Наш вхідний потік розділений на окремі пакети даних — батчі, кожен з яких містить події певного радіального сектора сканування. Кожному батчу присвоєно залізний порядковий номер провайдера — `Provider Sequence`. На вході вони мають чіткий порядок: батч №1, №2, №3, №4.
