...
## 1.1. Доказова інженерія без сторонніх інструментів
...
## 1.2. Деталізація CPU за допомогою `dotnet-trace`
...
## 1.4. Темп алокацій через `dotnet-counters`
...
## 1.5. Аналіз живої купи через `dotnet-gcdump`
