...
## 7.1. Що саме має збігатися з Windows-маршрутом
...
## 7.3. Малий smoke-cache: швидка перевірка кешу
...
## 7.4. Кеш, еквівалентний авторському корпусу
...
## 7.5. Функціональна валідація архіву
...
## 7.6. Коротка перевірка продуктивності
...
## 7.7. Доказовий пакет продуктивності
...
## 7.9. Мінімальна карта “усе працює”
...
| Доказ продуктивності | `tee` маршрут з 7.7 | Сирі журнали містять середовище, контур кешу, контрольні суми, пропускну здатність і алокації |

---

## 7.10. Межі відповідальності цього додатка
