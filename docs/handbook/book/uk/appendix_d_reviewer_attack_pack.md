...
| 23-30 хв | Цей набір атак нижче; за потреби — тільки секції `6.9`/`7.9` в інструкціях для платформи | Які два-три питання варто поставити автору наживо і чи є маршрут до відтворення без приватних інструкцій |
