...
## 6.3. Малий smoke-cache: швидка перевірка, що конвеєр живий
...
## 6.4. Кеш, еквівалентний авторському корпусу
...
## 6.5. Функціональна перевірка маршруту архіву
...
## 6.6. Коротка перевірка продуктивності: не плутати smoke-перевірку з твердженням
...
## 6.7. Доказ продуктивності: як отримати не скріншот, а доказ
...
## 6.8. Пакет демо продукту: перевірка UI та API без підміни доказу кешу
...
## 6.9. Мінімальна карта “усе працює”
...
| Доказ продуктивності | `Tee-Object` маршрут з 6.7 | Сирі журнали містять середовище, контур кешу, контрольні суми, пропускну здатність і алокації |
...
## 6.10. Межі відповідальності цього додатка
