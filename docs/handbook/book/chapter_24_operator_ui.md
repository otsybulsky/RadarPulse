...
* BFF мусить видати агрегований visual DTO або tile/raster model, а не внутрішні runtime structures.
...
Тому ця книга фіксує чесний стан: реалізований UI є read-model cockpit для перевірки системи. High-frequency radar visualization лишається названим наступним напрямком, а не прихованою вигадкою в поточному резюме проекту.
