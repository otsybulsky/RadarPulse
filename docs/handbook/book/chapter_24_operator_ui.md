...
* **Доставка з того самого джерела (Same-Origin Delivery)**: Збірка Angular SPA інтегрується прямо в ресурси `RadarPulse.Http` та віддається з тієї ж адреси, усуваючи потребу в CORS конфігураціях.
