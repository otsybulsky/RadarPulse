...
У нашій детективній історії ми називаємо його «Старшиною черги». Його характер непохитний, його блокнот ведеться за номером sequence, а логіка роботи нагадує механічний сейф із кількома секціями.
