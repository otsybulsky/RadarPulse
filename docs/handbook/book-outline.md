...
*   **Розділи:**
    ...
    *   **[Розділ 16: Справа про мутабельне ядро (Блокер Slice 3)](book/chapter_16_mutable_core.md)**
        *   *Технічне підґрунтя:* `021-ordered-concurrent-runtime-archive-processing-slice-3-blocker.md`.
        *   *Сюжет:* Архітектурна помилка, коли паралельні воркери перезаписували спільний мутабельний стан ядра. Розділення рантайму на дві ізольовані фази: розрахунок немутабельних `RadarProcessingBatchDelta` та строго послідовна впорядкована фіксація (Ordered Commit). Аналіз матриці продуктивності (active=4 vs active=1).
